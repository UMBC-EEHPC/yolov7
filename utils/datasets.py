...
class Albumentations:
    ...
    def __init__(self):
        ...
        self.transform = A.Compose([
            A.CLAHE(p=0.35),
            A.RandomBrightnessContrast(brightness_limit=0.5, contrast_limit=0.5, p=0.15),
            A.RandomGamma(gamma_limit=[40, 160], p=0.15),
            A.Blur(p=0.35),
            A.RGBShift(p=0.35),
            A.ChannelDropout(p=0.35),
            A.ChannelShuffle(p=0.35),
            A.MotionBlur(p=0.35),
            A.ToGray(p=0.35),
            A.ImageCompression(quality_lower=55, p=0.35),
            A.Emboss(p=0.15),
